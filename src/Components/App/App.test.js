...
describe("App", () => {
  ...
  it("should be able to remove a favorite character from state", () => {
    ...
    wrapper.instance().addFavoriteCharacter(updatedCharacter);
  ...
  it("should be able to update the userMenu state to true", () => {
    wrapper.instance().setState({
      showFormModal: false,
      showPlanetModal: false,
      showUserMenu: false,
  ...
  it("should update user information in state when a user logs out", () => {
    wrapper.instance().setState({
      showFormModal: false,
      showPlanetModal: false,
      showUserMenu: false,
    ...
    wrapper.instance().userLogoutReset();
